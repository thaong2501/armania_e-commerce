        ...
        <main class="page-main page-content bg-white mg-bot-60">
            <div class="grid wide page-cart-checkout">
                ...
                <div class="row container">
                    <div class="col l-9 m-12 c-12 cart-main">
                        <div class="cart-main-wrapper">
                                        ...
                                        <div class="cart-main-product__info-detail-wrapper">
                                            <div class="cart-main-product__info-detail">
                                                <div class="product-price">
                                                    <span class="price-final">$369.99</span>
                                                </div>
                                            ...
                                            <div class="cart-main-product__action">
                                                <a href="" class="action-edit" title="Edit item parameters">
                                                    <i class="fas fa-cog"></i>
                                                </a>
                                                <a href="" class="action-remove" title="Remove item">
                            ...
                            <div class="cart-main-action">
                                <div class="left">
                                    <a href="" class="action-continue btn-primary">
                                        <i class="ti-angle-left"></i>
                                        Continue Shopping
                                    </a>
                                </div>
                                <div class="right">
                                    <button class="action-clear btn-primary">
                                        Clear Shopping Cart
                                    </button>
                                    <button class="action-update btn-primary">
                    ...
                    <div class="col l-3 m-12 c-12 cart-summary">
                        ...
                        <div class="block-shipping">
                            ...
                            <div class="block-shipping-summary panel-collapse">
                                ...
                                <form action="" class="shipping-method-form">
                                    <div class="shipping-method-wrapper">
                                        <div class="shipping-method-item">
                                            <div class="shipping-method-item__title radio-title">
                                                <span>Free Shipping</span>
                                            </div>
                                            <div class="shipping-method-item__option radio-option">
